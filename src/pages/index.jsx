  ...
  return (
    <>
                    ...
                    <ul>
                      ...
                      <li className="has-dropdown ">
                        ...
                        <ul className="submenu text-start">
                          ...
                          <li>
                            <a href="portfolio-mesonary.html">
                              Portfolio Masonry
                            </a>
                          </li>
                          <li>
      ...
      <div
        ...
        className={`tp-md-menu header-transparent d-lg-none pt-40 pb-40 ${
          isOffcanvasVisible ? "active" : ""
        }`}
      >
        <div
          className={`container-fluid ${isOffcanvasVisible ? "opened" : ""}`}
        >
          <div className="row align-items-center">
            <div className="col-6">
              <div className="tp-logo">
                ...
                <div className="col-xl-7 col-lg-7">
                  <div className="tp-hero-content">
                    <div className="tp-hero-text">
                      ...
                      >
                        <a
                          className="tp-btn mr-30"
                          href="portfolio-details.html"
                        >
                          Visit Case Studies
                        </a>
                        <a className="tp-btn-grey" href="about-me.html">
                          About Collax <i className="far fa-arrow-right"></i>
                        </a>
                      </div>
                      <div
                      ...
                      >
                        <div className="tp-hero-social bp-hero-social">
                          <a className="social-icon-1" href="#">
                            <i className="fab fa-facebook-f social-icon-1"></i>
                            <span>Facebook</span>
                          </a>
                          <a className="social-icon-3" href="#">
                            <i className="fab fa-youtube social-icon-3"></i>
                            <span>youtube</span>
                          </a>
                          <a className="social-icon-2" href="#">
                            <i className="fab fa-twitter social-icon-2"></i>
                            <span>twitter</span>
                          </a>
                          <a className="social-icon-4" href="#">
                            <i className="fab fa-behance social-icon-4"></i>
                            <span>behance</span>
                          </a>
                        </div>
                      </div>
                ...
                <div className="col-lg-12">
                  <div className="tp-creative-box text-center">
                    <div className="tp-creative-content mb-110">
                      <h4 className="tp-creative-title">
                        We deploy world-class <b>Creative Design team</b> on
                        demand. that can design, build, ship and scale your
                        vision in the most efficient way.
                      </h4>
                    </div>
              ...
              <div className="creative-box pl-40 pr-40">
                <div className="row gx-5">
                  <div className="col-lg-4 col-md-12 col-xs-12 mb-30">
                    <div
                      className="tp-creative-item wow tpfadeUp"
                      data-wow-duration=".3s"
                      data-wow-delay=".6s"
                    >
                  ...
                  <div className="col-lg-4 col-md-12 col-xs-12 mb-30">
                    <div
                      className="tp-creative-item tp-creative-blue wow tpfadeUp"
                      data-wow-duration=".5s"
                      data-wow-delay=".8s"
                    >
                      <div className="tp-creative-yellow d-flex align-items-center">
                  ...
                  <div className="col-lg-4 col-md-12 col-xs-12 mb-30">
                    <div
                      className="tp-creative-item tp-creative-pink wow tpfadeUp"
                      data-wow-duration=".7s"
                      data-wow-delay="1s"
                    >
                      <div className="tp-creative-yellow d-flex align-items-center">
            ...
            <div className="row">
              <div className="col-lg-6 col-md-12 col-12">
                ...
                >
                  ...
                  <a className="tp-btn" href="service-details.html">
                    View All Services
                  </a>
                </div>
              </div>
                  ...
                  <div className="tp-service-item d-flex mb-30">
                    ...
                    <div className="tp-sv-content pl-60">
                      <h3 className=" tp-sv-title mb-35">
                        <a href="service-details.html">Ideation & Evaluation</a>
                      </h3>
                      <p className="mb-30">
                        At Collax we specialize in designing, building, shipping
                        and scaling beautiful, usable products with blazing-fast
                      </p>
                      <p>
                        At Collax we specialize in designing, building, shipping
                        and scaling...
                    ...
                    <div className="col-xl-6 col-lg-12">
                      <div className="tp-project-box mb-20">
                        <div className="tp-project-img fix mb-45">
                          <img
                            className="w-100"
                            src="assets/img/project/brand-1.jpg"
                            alt=""
                          />
                        </div>
                      ...
                      <div className="row">
                        <div className=" col-xl-12 col-lg-12">
                          <div className="tp-project-box-sm d-flex align-items-center mb-20">
                            <div className="tp-project-sm-img fix ml-25 mr-35">
                              <img
                                src="assets/img/project/brand-2.jpg"
                                alt=""
                              />
                            </div>
                            <div className="tp-project-sm-content">
                        ...
                        <div className="col-xl-12 col-lg-12">
                          <div className="tp-project-box-sm d-flex align-items-center">
                            <div className="tp-project-sm-img fix ml-25 mr-35">
                              <img
                                src="assets/img/project/brand-3.jpg"
                                alt=""
                              />
                            </div>
                            <div className="tp-project-sm-content">
                    ...
                    <div className="col-xl-6 col-lg-12">
                      <div className="tp-project-box mb-20">
                        <div className="tp-project-img fix mb-45">
                          <img
                            className="w-100"
                            src="assets/img/project/app-1.jpg"
                            alt=""
                          />
                        </div>
                        <div className="tp-project-content ml-20">
                  ...
                  <div className="swiper-slide">
                    <div className="tp-testimonial-item">
                      ...
                      <div className="tp-testi-p-text">
                        <p>
                          Collax was very diligent, polite and extremely
                          customer oriented. I think Monika will go far with
                          that attitude and ...he is such a honest, decent and
                          reliable.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="tp-testimonial-item">
                      <div className="tp-testi-meta d-flex justify-content-between mb-40">
                        <div className="tp-testi-icon-box d-flex align-items-center">
                          <div className="tp-testi-img mr-20">
                            <img
                              src="assets/img/testimonial/testi-2.jpg"
                              alt=""
                            />
                          </div>
                          <div className="tp-testi-client-position">
                    ...
                    <div className="tp-testimonial-item">
                      <div className="tp-testi-meta d-flex justify-content-between mb-40">
                        <div className="tp-testi-icon-box d-flex align-items-center">
                          <div className=" tp-testi-img mr-20">
                            <img
                              src="assets/img/testimonial/testi-3.png"
                              alt=""
                            />
                          </div>
                          <div className="tp-testi-client-position">
                    ...
                    <div className="tp-testimonial-item">
                      <div className="tp-testi-meta d-flex justify-content-between mb-40">
                        <div className="tp-testi-icon-box d-flex align-items-center">
                          <div className="tp-testi-img mr-20">
                            <img
                              src="assets/img/testimonial/testi-4.jpg"
                              alt=""
                            />
                          </div>
                          <div className="tp-testi-client-position">
                      ...
                      <div className="tp-testi-p-text">
                        <p>
                          Absolutely amazing. we can't believe how incredible
                          this turned out. Yetta Thomas is a true professional.
                          he is such a honest, decent and reliable. He always
                    ...
                    <div className="tp-testimonial-item">
                      <div className="tp-testi-meta d-flex justify-content-between mb-40">
                        <div className="tp-testi-icon-box d-flex align-items-center">
                          <div className="tp-testi-img mr-20">
                            <img
                              src="assets/img/testimonial/testi-5.jpg"
                              alt=""
                            />
                          </div>
                          <div className="tp-testi-client-position">
                      ...
                      <div className="tp-testi-p-text">
                        <p>
                          Collax is a very talented designer and his most
                          valuable role is to teach design in a professional
                          way. He trained design courses under my company
                    ...
                    <div className="tp-testimonial-item">
                      <div className="tp-testi-meta d-flex justify-content-between mb-40">
                        <div className="tp-testi-icon-box d-flex align-items-center">
                          <div className=" tp-testi-img mr-20">
                            <img
                              src="assets/img/testimonial/testi-6.jpg"
                              alt=""
                            />
                          </div>
                          <div className="tp-testi-client-position">
        ...
        <div className="tp-blog-area pt-130 pb-120 p-relative">
          ...
          <div className="container">
            ...
            <div className="row gx-40">
              ...
              <div className="col-xl-6 col-lg-6">
                <div
                  className="tp-blog-box mb-30 wow tpfadeRight"
                  data-wow-duration=".7s"
                  data-wow-delay=".6s"
                >
                  <div className="tp-blog-item">
                    ...
                    <div className="tp-blog-info">
                      <h3 className="tp-blog-title">
                        <a href="blog-details.html">
                          How to grow your business with collax digital
                          solution.
                        </a>
                      </h3>
                      <p>
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="tp-blog-button text-center mt-30">
                  <a className="tp-btn" href="blog-details.html">
                    View Case Studies
                  </a>
                </div>
              </div>
        ...
        >
          <div className="container">
            <div
              ...
              data-background="assets/img/news/news-shape.png"
            >
              <div className="row">
                <div className="col-xl-6 col-lg-6 col-md-8 col-12  ">
                  <div className="tp-news-wrapper pl-90 z-index-1">
                    <div className="tp-news-letter-section-box">
                      ...
                      <h2 className="tp-title tp-white-text">
                    ...
                    <div className="tp-news-button p-relative">
                      <form action="#">
                        ...
                        <button
                          ...
                          type="submit"
                        >
                          Subscribe <i className="far fa-arrow-right"></i>
                        </button>
                      </form>
                    </div>
                  </div>
                ...
                <div className="col-xl-7 col-lg-7 col-md-7 col-12">
                  <div className="tp-footer-top">
                    <h5 className="tp-footer-title">
                      More than 10 years in the game and we're <br /> just
                      getting started. 🤝
                    </h5>
                  </div>
                </div>
                ...
                <div className="row align-items-center">
                  <div className="col-xl-5 col-lg-5 col-md-5 col-12">
                    <div className="tp-copyright-text z-index-1">
                      <p className="m-0">
                        © 2022 Creative Agency , All Right Receved.
                      </p>
                    </div>
                  </div>
                  <div className="col-xl-7 col-lg-7 col-md-7 col-12">
                ...
                <div className="row align-items-center">
                  <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                    <div className="tp-copyright-logo mt-35">
                      <a href="index.html">
                        <img
                          src="assets/img/copyright/copyright-logo.png"
                          alt=""
                        />
                      </a>
                    </div>
      ...
      <button
        className="scroll-top scroll-to-target d-md-none"
        data-target="html"
      >
