               ...
               <div class="col-xl-12">
                  <div class="amskill">
                     <div class="amskill__title">
                        <h3 class="am-skill-title">Personal Background</h3>
                        <p class="pb-10"> 
            ...
            <div class="row feature-bottom-space">
               <div class="col-xl-4 col-lg-4">
                  <div class="amfeature">
                     ...
                     <div class="amfeature__list">
                        <ul>
                           <li><i class="fal fa-check"></i> Nodejs</li>
                           <li><i class="fal fa-check"></i> Expressjs</li>
                           <li><i class="fal fa-check"></i> React</li>
                           <li><i class="fal fa-check"></i> React Native</li>
                           <li><i class="fal fa-check"></i> Angular</li>
                           <li><i class="fal fa-check"></i> PHP</li>
                           <li><i class="fal fa-check"></i> Laravel</li>
                           <li><i class="fal fa-check"></i> AWS</li>
                           <li><i class="fal fa-check"></i> Web Hosting & Management</li>
                           <li><i class="fal fa-check"></i> Jira</li>
                           <li><i class="fal fa-check"></i> And many more...</li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4">
                  <div class="amfeature am-fea-space">
                     ...
                     <div class="amfeature__list">
                        <ul>
                           <li><i class="fal fa-check"></i> Primary School</li>
                           <li><i class="fal fa-check"></i> Secondary School</li>
                           <li><i class="fal fa-check"></i> University</li>
                           <li><i class="fal fa-check"></i> Vocational Education</li>
                           <li><i class="fal fa-check"></i> Technical Training in Technology</li>
                           <li><i class="fal fa-check"></i> IT Training</li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4">
                  <div class="amfeature am-fea-space-2">
                     ...
                     <div class="amfeature__list">
                        <ul>
                           <li><i class="fal fa-check"></i> State Government Award</li>
                           <li><i class="fal fa-check"></i> Organization Recognition</li>
                           <li><i class="fal fa-check"></i> National Youth Corp Award</li>
                           <li><i class="fal fa-check"></i> Private Companies Recognition</li>
                           <li><i class="fal fa-check"></i> Non Profit Organization Award</li>
                           <br/><br/>
                        </ul>
                     </div>
                  </div>
                ...
                <div class="row" style="p-5">
                    <br/><br/>
                        <div class="col-xl-8 col-lg-7 col-md-7 col-12">
                            <div class="tp-footer-button text-start text-md-end">
                                <a class="tp-btn" href="assets/document/abel_ken_cv.pdf" download>Download My CV<i class="far fa-arrow-right"></i> </a>
                            </div>
                        </div>    
                </div>
            </div>
